   ...
   <div class="row">
    <div class="col-md-3 col-sm-6">
	 <div class="trendPortfolio">
	  <div class="trendNew"><img src="<?php echo base_url();?>assets/images/templet-2.png" /><div class="hoverBlockDiv"><a href="" class="left"><i class="fa fa-eye"></i> Preview</a><a href="themes/buynow?p=Boundless&pr=200" class="right"><i class="fa fa-shopping-cart "></i> Buy Now</a></div></div>
